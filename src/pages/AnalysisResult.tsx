        ...
        <div className="space-y-8">
          ...
          <div className="glass-panel p-8 rounded-[2rem] space-y-5">
            ...
            <div className="pt-5 border-t border-slate-200/50">
              ...
              <div className="h-2.5 w-full bg-slate-200/60 rounded-full overflow-hidden shadow-inner">
                <div className="h-full bg-brand-500 w-[92%] rounded-full shadow-sm" />
              </div>
              <p className="text-[10px] text-slate-400 mt-3 font-medium">Based on document clarity and AI extraction confidence.</p>
            </div>
          </div>

          {/* Suggested Questions */}
          <div className="glass-panel p-8 rounded-[2rem]">
            <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] mb-5">Suggested Questions</h3>
          ...
          <div className="bg-gradient-to-br from-slate-50 to-slate-100 border border-slate-200 rounded-[2rem] p-6 shadow-sm">
            ...
            <p className="text-xs text-slate-500 font-medium leading-relaxed">
              This analysis is generated by AI and is for informational purposes only. It does not constitute legal advice. Always review the original document.
            </p>
          </div>
        </div>
      </div>
